...
import { GeoJSON, MapContainer, Marker, Popup, ScaleControl } from "react-leaflet"; // Import Popup
...
export default function ChoroplethMapDrillDown() {
  ...
  useEffect(() => {
    ...
    // Clear previous markers and add new markers for Andhra Pradesh and Bhimavaram
    setMarkers([
      // { position: [16.3, 80.45], name: "Andhra Pradesh" }, // Latitude and longitude for Andhra Pradesh
      //
      // Latitude and longitude for Bhimavaram
      { position: [17.1234, 79.5432], name: "Telangana" },
    ]);
  }, [geoJsonId]);
