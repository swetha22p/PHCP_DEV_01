...
const defaultCircle = L.circleMarker([0, 0], {
  ...
  return (
    <div>
    <div><h1>DRIVE NAME</h1></div>
    <div className={styles["rectangle-box"]}>
        <div className={styles["rectangle-box__timeline"]}>
            <div>Timeline</div>
            {/* Add more timeline events as needed */}
        </div>
    </div>
    <div className={styles["button-container"]}>
    <div className={styles["rectangle-button"]}>Activity 1</div>
    <div className={styles["rectangle-button"]}>Activity 2</div>
    <div className={styles["rectangle-button"]}>Activity 3</div>
    <div className={styles["rectangle-button"]}>Activity 4</div>
</div>
<div className={styles["button-container"]}>
<div className={styles["square-box"]}>
    
    <MapContainer
        center={[17.1232, 79.2088]} // Centered on the specified coordinates
    ...
    <div className={styles["rectangle-box3"]}>
        <div className={styles["button-container"]}>
            <div>Field Activity1</div>
            <div className={styles["rectangle-box1"]}>
           
    <div>
        <label htmlFor="regionDropdown">Region:</label>
        <select id="regionDropdown" >
            ...
            <optgroup label="Telangana">
                ...
                {/* Add more Telangana regions as needed */}
            </optgroup>
            <optgroup label="Andhra Pradesh">
                <option value="vijayawada">Vijayawada</option>
                <option value="visakhapatnam">Visakhapatnam</option>
                <option value="guntur">Guntur</option>
                {/* Add more Andhra Pradesh regions as needed */}
            </optgroup>
        </select>
    </div>
        ...
        <div className={styles["rectangle-box2"]}>
    {/* <div className={styles["rectangle-box__timeline"]}> */}
        <div>
...
<button onClick={handleDriveData} style={{ marginLeft: "85px" ,  }}>Drive Data</button>
<button onClick={handleAssistants} style={{ marginLeft: "25px" }}>Assistants Data</button>
